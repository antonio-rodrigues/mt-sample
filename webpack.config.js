  ...
  let returner = {
    ...
    module: {
      rules: [
        ...
        {test: /\.js$/, exclude: /node_modules(\/|\\)(?!(https|framework7|framework7-vue|template7|dom7)(\/|\\)).*/, use: {loader: 'babel-loader', options: {presets: ['env'], plugins: [ 'transform-runtime', 'transform-object-rest-spread' ]}}}
      ]
    },
